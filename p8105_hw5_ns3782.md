...
The homicides dataset contains information about homicides in multiple
U.S. cities. The dataset has 52179 homicide cases with 13 variables:
uid, reported_date, victim_last, victim_first, victim_race, victim_age,
victim_sex, city, state, lat, lon, disposition, city_state. The cases
span from 2.0070101^{7} through 2.015111^{8}. The data covers 51 cities.
...
Asian, Unknown). Case dispositions fall into the following categories:
Closed without arrest, Closed by arrest, Open/No arrest. Each case has
geographic coordinates (latitude and longitude) and a unique identifier
(uid).
